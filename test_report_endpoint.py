...
def test_report_endpoint():
    ...
    try:
        ...
        history_response = requests.get(
            f"{BASE_URL}/api/interview/history", headers=headers
        )
        ...
        report_response = requests.get(
            f"{BASE_URL}/api/interview/report/{interview_id}", headers=headers
        )
        ...
        if not all(
            k in interview_info
            for k in ["interview_id", "start_time", "end_time", "total_questions"]
        ):
        ...
        print(
            f"   Performance Level: {performance_summary.get('performance_level', 'N/A')}"
        )
...
def create_test_interview(headers):
    ...
    try:
        ...
        start_response = requests.post(
            f"{BASE_URL}/api/interview/start", headers=headers
        )
        ...
        complete_response = requests.post(
            f"{BASE_URL}/api/interview/complete/{interview_id}", headers=headers
        )
