...
class InterviewCRMTester:
    ...
    def test_resume_upload_text(self):
        ...
        try:
            ...
            response = requests.post(f"{self.base_url}/api/interview/resume", 
    ...
    def test_interview_start(self):
        ...
        try:
            ...
            response = requests.post(f"{self.base_url}/api/interview/start", 
    ...
    def test_answer_processing(self):
        ...
        try:
            ...
            response = requests.post(f"{self.base_url}/api/interview/process", 
    ...
    def test_interview_completion(self):
        ...
        try:
            ...
            response = requests.post(f"{self.base_url}/api/interview/complete/{self.interview_id}", 
                                   headers=headers)
            if response.status_code == 200:
                data = response.json()
    ...
    def test_dashboard_stats(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   Average overall score: {data.get('average_scores', {}).get('overall', 0)}")
                return True
            else:
